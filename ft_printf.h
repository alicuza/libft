...
/*   Updated: 2025/11/30 20:44:02 by sancuta          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FLAG_PLUS	(1 << 3) // bits for '+': 00001000 =  8
# define FLAG_SPACE	(1 << 4) // bits for ' ': 00010000 = 16
# define FLAG_DOT	(1 << 5) // bits for '.': 00100000 = 32
# define FLAG_NEG	(1 << 6) // bits for n<0: 01000000 = 64
# define FLAG_SIGN	(FLAG_NEG | FLAG_PLUS | FLAG_SPACE) // bits: 01011000 = 64 + 16 + 8 = 88
